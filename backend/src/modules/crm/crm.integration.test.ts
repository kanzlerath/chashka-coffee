...
maybeDescribe('CRM API integration', () => {
  const env: AppEnv = {
    ...
    COOKIE_SECURE: false, MEDIA_UPLOAD_MAX_BYTES: 10 * 1024 * 1024, MEDIA_VIDEO_UPLOAD_MAX_BYTES: 100 * 1024 * 1024, WEBSITE_BUILD_DEBOUNCE_SECONDS: 45, WEBSITE_BUILD_POLL_SECONDS: 10, WEBSITE_BUILD_RETRY_SECONDS: 300, SPACES_UPLOAD_MAX_BYTES: 10 * 1024 * 1024, SPACES_UPLOAD_URL_TTL_SECONDS: 900,
