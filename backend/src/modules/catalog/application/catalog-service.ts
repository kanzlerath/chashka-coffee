import type { AssignRestaurantMenuRequest, RestaurantListQuery, UpsertMenuCategoryRequest, UpsertMenuItemRequest, UpsertMenuRequest, UpsertRestaurantRequest } from '@chashka-coffee/contracts'
