...
docker compose exec postgres pg_isready -U superuser -d chashka_coffee
```
...
host: localhost
port: 54329
database: chashka_coffee
user: superuser
password: superpassword
DATABASE_URL: postgresql://superuser:superpassword@localhost:54329/chashka_coffee?schema=public
```
