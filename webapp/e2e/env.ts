...
export const composeProjectName =
  process.env.COMPOSE_PROJECT_NAME ?? `chashka-coffee-${repositoryHash}`
...
export const defaultDatabaseUrl = `postgresql://superuser:superpassword@localhost:${defaultPostgresTestPort}/chashka_coffee_test?schema=public`
