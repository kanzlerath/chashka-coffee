...
export function JobsPage({ mode = 'list', openingId }: { mode?: 'list' | 'create' | 'edit'; openingId?: string }) {
  ...
  return <section className="admin-page admin-page-editor">
    <AdminPageHeader eyebrow="Вакансии" title={selected?.title ?? 'Новая вакансия'} description="Привяжите вакансию к заведению — на сайте она появится в соответствующем фильтре с адресом точки." actions={<Button asChild variant="outline"><Link to="/jobs">К списку вакансий</Link></Button>} />
