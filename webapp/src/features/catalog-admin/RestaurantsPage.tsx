...
export function RestaurantsPage() {
  ...
  function choose(restaurant: AdminRestaurant) { setSelected(restaurant); setDraft(toDraft(restaurant)); setOverrideItem(null); setScheduleDraft(emptyScheduleException()) }
  function startNew() { setSelected(null); setDraft({ ...emptyRestaurant, openingHours: defaultHours.map((entry) => ({ ...entry })) }); setOverrideItem(null); setScheduleDraft(emptyScheduleException()) }
